...
function alunizaje()
{
    if (v <= 10)
        ...
        document.getElementById("imgnave").src="img/arbre.jpg";
        alert("Felicidades por haber llegado vivo!");
    ...
    alert("Prueba de nuevo a menos velocidad, te acabas de estrellar");
